...
export default function ProductSlider({ products }: any) {
  return (
    <div className="relative">
      ...
      {/* RIGHT ARROW */}
      <button className="swiper-button-next-custom block absolute -right-3 lg:-right-15 top-1/2 -translate-y-1/2 z-10 bg-white shadow rounded-full p-3 dark:text-black">
